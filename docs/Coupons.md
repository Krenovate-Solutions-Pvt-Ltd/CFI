...
[**Sample CSV**](https://docs.google.com/spreadsheets/d/1chs891NJEUcwYyTBVv-hyAN_eOvG_WWfjxFOwAkjEtI/edit?usp=sharing "Sample CSV") 
...
---------|----------|---------|---------
 ...
 Usage Limit | usage_limit | Specify the total number of times the coupon can be used | 1,2
 Usage Limit Per User | usage_limit_per_user | Specify the total number of times the coupon can be used by a single user | 1,2
 Limit Usage | limit_usage_to_x_items | Specify the total number of items the coupon can be applicable to | 3,5,16
 ...
 Minimum Amount | minimum_amount | C1 | D1
 Maximum Amount | maximum_amount | C2 | D2
 Customer Email | customer_email | Enter the email id of the user | abc@xyz.com
...
Watch the <a href="https://www.youtube.com/watch?v=b3Ix0WB3Bwg&t=196s" target="_blank">**Video Tutorial**</a> to understand how to use the CSV Importer